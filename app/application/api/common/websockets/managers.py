...
class BaseConnectionManager(ABC):
    connections_map: DefaultDict[str, List[WebSocket]] = field(default_factory=lambda: defaultdict(list), kw_only=True)
    ...
    @abstractmethod
    async def send_all(self, key: str, json_message: Mapping[str, Any]) -> None:
        ...
